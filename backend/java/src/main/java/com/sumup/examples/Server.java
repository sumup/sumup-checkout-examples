...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SumUpClient client = SumUpClient.builder()
        ...
        server.createContext("/checkouts", exchange -> handleCreateCheckout(exchange, client, merchantCode));
    ...
    private static void handleCreateCheckout(HttpExchange exchange, SumUpClient client, String merchantCode)
        throws IOException {
